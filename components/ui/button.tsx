...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(({ 
    ...
    const iconSizeMap: Record<SizeKey, number> = {
        xs: 12,
        sm: 14,
        default: 16,
        lg: 18,
    ...
    const calculatedIconSize = iconSize ?? iconSizeMap[(size ?? 'default') as SizeKey];
    ...
    if (asChild) {
        try {
            ...
            const child = React.Children?.only(children) as React.ReactElement<{ className?: string; disabled?: boolean; children?: React.ReactNode }>;
